  ...
  <div class="pagination-container" *ngIf="page && page.totalPages > 0">
      <nav aria-label="Page navigation">
          <ul class="pagination">
              ...
              <select style="margin-top:8px;margin-left:5px" (ngModelChange)="changePage()" [(ngModel)]="size" class="custom-select">
...
export class PaginationComponent implements OnInit {
    ...
    setPagetion(){
        this.page.last = (this.page.totalPages - 1);
        ...
        let fim = (this.page.totalPages - 1);
